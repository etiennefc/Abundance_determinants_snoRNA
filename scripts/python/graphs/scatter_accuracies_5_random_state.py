...
# Define function to return the average and standard deviation of accuracies of the 5 random_state iterations per model in a respective dict each
...
# Get the average and standard deviation of CV, training and test sets accuracies for all models across the 5 iterations
