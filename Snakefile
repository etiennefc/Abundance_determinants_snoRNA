...
rule all:
    input:
        ...
        #shap_local_FN_log = expand("log/shap_local_FN_{models}.log", models=config['models']),
        #shap_local_FP_log = expand("log/shap_local_FP_{models}.log", models=config['models']),
        #shap_local_TN_log = expand("log/shap_local_TN_{models}.log", models=config['models']),
        #shap_local_TP_log = expand("log/shap_local_TP_{models}.log", models=config['models']),
